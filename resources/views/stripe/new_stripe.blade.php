                    ...
                    <form role="form" 
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <input id="example1-name" name="name" data-tid="elements_examples.form.name_placeholder" type="text" placeholder="Jane Doe" required="" autocomplete="name" onkeydown="return alphaOnly(event);" >
                            </div>
                            <div class="row">
                                <label for="example1-email" data-tid="elements_examples.form.email_label">Email</label>
                                <input id="example1-email" name="email" data-tid="elements_examples.form.email_placeholder" type="email" placeholder="janedoe@gmail.com" required="" autocomplete="email">
                            </div>
                            <div class="row">
                                <label for="example1-phone" data-tid="elements_examples.form.phone_label">Phone</label>
                                <input id="example1-phone" name="phone" data-tid="elements_examples.form.phone_placeholder" type="tel" placeholder="(941) 555-0123" required="" autocomplete="tel" onkeypress="return validateNumber(event)">
                            </div>
                            <div class="row">
                                <label for="example1-amount" name="amount" data-tid="elements_examples.form.amount_label">Amount</label>
                                <input id="example1-amount" data-tid="elements_examples.form.phone_placeholder" name="amount" type="tel" placeholder="100$" required="" autocomplete="tel" onkeypress="return validateNumber(event)">
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="row">
